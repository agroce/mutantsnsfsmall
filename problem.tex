...
Thus, our proposed 
mutation framework aims to generate a small, diverse set of
mutants that are characterized by their novelty to present to the developer or test engineer.  
...
The proposed framework then works \emph{with} the test engineer to improve the SUT or
...
This provides a stopping rule other than patience, time available, or
