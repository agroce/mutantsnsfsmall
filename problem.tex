...
Our approach thus fundamentally seeks to identify a small set of maximally different, \emph{maximally interesting} mutants to present, based on feedback and project context.
