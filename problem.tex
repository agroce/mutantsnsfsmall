...
redundant mutants, and a much smaller number of \emph{actionable
  mutants} that can improve tests.  EExamining
surviving mutants even in the presence of formal verification and
aggressive automated fuzzing  is
time-consuming and unpleasant, as PI Groce and co-authors noted in prior work~\cite{groce2015verified,groce2018verified,mutKernel}.
%
...
Unfortunately, the
methods proposed were very limited in applicability, due to an
...
Our approach thus fundamentally seeks to identify a small set of
maximally different, \emph{maximally interesting} mutants to present,
