...
code changes has proven imperative over the last decade, and is now widely
adopted in industry~\cite{codemod-gh, codemod-fb-post-by-codemod-author, dart-codemod}. Interactive prompts incorporate human oversight before the code is changed. \textbf{RVT comment: To give an idea, here is what such a typical workflow looks like in FB's codemod, example from the dart code mod tool: \url{https://pub.dev/packages/codemod}. End comment.}
