...
\paragraph{Using differential mutation analysis to evaluate and
  improve static analysis tools.}
...
\emph{improve} static analysis tools.  This work is TODO: ICSE result
(either accepted to ICSE or in submission).
...
identify three new candidate
detector patterns for the Slither tool, based on mutants killed by
Securify, SmartCheck, or both, but not by Slither:  Boolean constant
