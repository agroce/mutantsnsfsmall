...
testing.  We also implemented a prototype version of mutant priorization, without feedback, in the tool, and the promising (but limited) effectiveness in helping analyze a set of over 45,000 mutants of on-blockchain smart contracts, discussed below in more detail, were highly encouraging.

{\bf TALK ABOUT COMBY HERE.}
